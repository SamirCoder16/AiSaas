  ...
  return (
    <div className="px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen">
        <div className="text-center mb-6">
            ...
            with <span className="text-primary">Quike-AI</span></h1>
        ...
        <div className="flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs">
            ...
            <button onClick={() => navigate('/ai/community')} className="bg-white px-10 py-3 rounded-lg border border-gray-300 hover:scale-102 active:scale-95 transition cursor-pointer">Watch demo</button>
        </div>
        <div className="flex items-center gap-4 mt-8 mx-auto text-gray-600">
            <img src={assets.user_group} alt="" className="h-8"/> Trusted by 60K+ people
        </div>
    </div>
  )
}
