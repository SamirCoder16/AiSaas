  ...
  return (
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500 mt-20">
          ...
          <div>
            ...
            <div className="text-sm space-y-2">
              ...
              <div className="flex items-center gap-2 pt-4">
                ...
                />
                <button className="bg-primary hover:scale-102 active:scale-95 cursor-pointer w-24 h-9 text-white rounded">
                  Subscribe
                </button>
              </div>
            </div>
      ...
      <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © <a href="https://port-flio.vercel.app/">SamirParvez</a>
        . All Right Reserved.
      </p>
    </footer>
  );
